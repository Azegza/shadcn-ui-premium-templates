...
export function OnboardingFlowStandard() {
              ...
              <>
                {currentStep === 0 && (
                  <div className="space-y-6">
                    ...
                    <Button type="button" onClick={() => nextStep(["fullName", "role"])} className="w-full">Next</Button>
                  </div>
                )}
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-2">
                      <Button type="button" variant="outline" onClick={prevStep}><ArrowLeft /></Button>
                      <Button type="button" onClick={() => nextStep(["workspaceName", "workspaceSlug"])} className="w-full">Next</Button>
                    </div>
                  </div>
                )}
