...
export function OnboardingClient({ variant = "premium" }: { variant?: "standard" | "premium" }) {
  ...
  return (
    <div className={cn(
      "relative w-full rounded-2xl border border-zinc-200 p-6 sm:p-10",
      variant === "premium" 
        ? "bg-white/60 shadow-xl shadow-zinc-200/50 backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-950/50 dark:shadow-zinc-900/50"
        : "bg-white dark:bg-zinc-900 shadow-sm dark:border-zinc-800"
    )}>
            ...
            <AnimatePresence mode="popLayout" custom={direction}>
              ...
              {isSuccess && (
                <motion.div
                  ...
                  transition={variant === "premium" ? { type: "spring", stiffness: 300, damping: 30 } : { duration: 0.2 }}
